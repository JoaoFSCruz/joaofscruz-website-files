<template>
    <div class="flex flex-col xl:flex-row h-full items-center">
        <div class="flex flex-col xl:w-3/5 p-4 space-y-5">

            <div>
                <h4 class="text-2xl lg:text-3xl font-semibold underline">
                    <a href="https://github.com/AlexOlival/ayo">Ayo</a>
                </h4>
            ...
            <p class="text-2xl">More upcoming...</p>

        </div>

        <div class="p-10">
            <img src="../assets/imgs/undraw_programming_2svr.svg" alt="">
        </div>
